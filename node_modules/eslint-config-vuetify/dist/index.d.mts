...
type Radix = [] | [("always" | "as-needed")]; // ----- regexp/hexadecimal-escape -----
...
type ConfigNames = 'vuetify/gitignore' | 'vuetify/js/recommended' | 'vuetify/js' | 'vuetify/imports' | 'vuetfiy/autoimports' | 'vuetify/unicorn/recommended' | 'vuetify/unicorn' | 'vuetify/regexp/recommended' | 'vuetify/perfectionist' | 'vuetify/vue/typescript__typescript-eslint/base' | 'vuetify/vue/typescript__typescript-eslint/eslint-recommended' | 'vuetify/vue/typescript__typescript-eslint/recommended' | 'vuetify/vue/typescript' | 'vuetify/vue' | 'vuetify/vue/jsx' | 'vuetify/typescript__typescript-eslint/base' | 'vuetify/typescript__typescript-eslint/eslint-recommended' | 'vuetify/typescript__typescript-eslint/recommended' | 'vuetify/typescript' | 'vuetify/typescript/dts' | 'vuetify/typescript/cjs-rules' | 'vuetify/stylistic' | 'vuetify/pnpm/package-json' | 'vuetify/pnpm/pnpm-workspace-yaml' | 'vuetify/jsonc/setup' | 'vuetify/jsonc/rules' | 'vuetify/antfu';
//#endregion
...
declare const optionsSchema: StrictObjectSchema<{
  ...
  readonly regexp: ExactOptionalSchema<UnionSchema<[BooleanSchema<undefined>, ObjectSchema<{
    readonly files: ExactOptionalSchema<ArraySchema<StringSchema<undefined>, undefined>, undefined>;
  }, undefined>], undefined>, true>;
